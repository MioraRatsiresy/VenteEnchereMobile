...
const ListeComponent = ({ mesEncheres }: { mesEncheres: any }) => {
    ...
    function openModal(idEnchere: number) {
        ...
        axios.get("http://192.168.169.77:4444/infoEnchere/" + idEnchere + "/" + sessionStorage.getItem("TokenUtilisateur")).then((response) => {
    ...
    function getAllPhoto(idEnchere: number) {
        axios.get("http://192.168.169.77:4444/getPhotoEnchere/" + idEnchere).then((response) => {
    ...
    function insertPhoto(id: any) {
        ...
        axios.post("http://192.168.169.77:4444/insertPhoto/" + id + "/" + sessionStorage.getItem("TokenUtilisateur"), photos).then((res) => {
            console.log(res);
            takePhoto(-3);
        });
        setIsOpen(false);
